...
<title>ADG Research | Join Now</title>
<!-- InstanceEndEditable -->
<!-- ../bootstrap -->
...
<div class="container marketing">
  ...
  <div class="page-header">
    <h1><!-- InstanceBeginEditable name="Header" -->Join Now<!-- InstanceEndEditable --></h1>
  </div>
  <!-- InstanceBeginEditable name="Content" -->
  <div class="container">

      <form class="form-signin" action="https://electronneutrino.com/as/join/join.php" method="post">
      	<label for="inputFirst" class="sr-only">First name</label>
        <input name="firstName" type="text" id="inputFirst" class="form-control" placeholder="First name" required autofocus>
        
        <label for="inputLast" class="sr-only">Last name</label>
        <input name="lastName" type="text" id="inputLast" class="form-control" placeholder="Last name" required autofocus>
        ...
        <div class="checkbox">
          <label>
            <input name="agree" type="checkbox" value="agree-conditions" required>I agree to the Terms and Conditions.
          </label>
        </div>
        <input id="rbtzM1crgk84E6aH" name="lat" type="hidden" value="0" />
	<input id="qxqHKYTCbgPTD3KC" name="lng" type="hidden" value="0" />
