...
<title>ADG Research | Log In</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
...
<div class="container marketing">
  ...
  <div class="page-header">
    <h1><!-- InstanceBeginEditable name="Header" -->Log In<!-- InstanceEndEditable --></h1>
  </div>
  <!-- InstanceBeginEditable name="Content" -->
  <div class="container">

      <form class="form-signin" action="https://electronneutrino.com/as/login/login.php" method="post" >
        ...
        <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me" checked="on" disabled="disabled" > Remember me
          </label>
        </div>
