...
<title>ADG Research | Dashboard</title>
<!-- InstanceEndEditable -->
<!-- ../bootstrap core CSS -->
    ...
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="page-header">
          <h1><span style="color:#000000"><?php echo $username; ?>&apos;s</span> Dashboard</h1>
        </div>
        <!--DYUSHA PASTE YOUR DASHBOARD CODE HERE-->
        <p>
					<?php
						if ($lat == 0 && $lng == 0) {
							echo "Your location is not configured properly. <a href=\"https://electronneutrino.com/as/settings/\">Configure now</a><br/>";
						}
					?>
				</p>
	<h2>Set State</h2>
	<p><a href="https://electronneutrino.com/as/dashboard/healthy.php">Healthy<!--<img src="http://www.jayway.com/wp-content/uploads/2013/05/thumbs-up-smiley-300x294.jpg" height="100" alt="Healthy" />--></a> or 
	<a href="https://electronneutrino.com/as/dashboard/sick.php">Sick<!--<img src="http://lh6.ggpht.com/_hKNB3rK03Zg/S4rEZ-AAEwI/AAAAAAAAAxY/J40AkSdeXaY/sick_smiley%255B5%255D.jpg%3Fimgmax%3D800" height="90" alt="Sick" />--></a>?</p>
	<?php
		if ($healthy == 1) {
			echo "<p>Your last input was: healthy</p>";
		} else {
			echo "<p>Your last input was: sick</p>";
		}
	?>
	<!--
        <br/>
        <button id="myValues" value="10">Check</button>(http://watchfluspread.mybluemix.net/api/25025)
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
        <script src="js/speedometer.js"></script>
	<script type="text/javascript">
		$("#myValues").val(Math.ceil(Math.random() * 100));
		$("#myValues").myfunc({divFact:10,eventListenerType:'click'});
	</script>
	-->
      </div>
    </div>
