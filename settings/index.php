...
<title>ADG Research | Settings</title>
<!-- InstanceEndEditable -->
<!-- ../bootstrap core CSS -->
    ...
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="page-header">
          <h1><span style="color:#000000"><?php echo $username; ?>&apos;s</span> Settings</h1>
        </div>
        <!--DYUSHA PASTE YOUR DASHBOARD CODE HERE-->
        <h2>Configure Location</h2>
        <p id="coords">Your current coordinates: <a href="https://www.google.com/maps/@<?php echo $lat; ?>,<?php echo $lng; ?>,22z" target="_blank"><?php echo $lat; ?>, <?php echo $lng; ?></a>.</p>
	<p>Use <a href="http://www.latlong.net/convert-address-to-lat-long.html" target="_blank">latlng.net</a> to help find out coordinates.</p>
	<form action="https://electronneutrino.com/as/settings/configurelocation.php" method="post">
		Latitude: <input class="form-control" name="lat" type="text" placeholder="42.360185" />
		Longitude: <input class="form-control" name="lng" type="text" placeholder="-71.091990" /><br/>
